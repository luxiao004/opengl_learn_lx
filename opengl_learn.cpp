...
int main()
{
    ...
    // ------------------------------------
    shader lightCubeShader("resources/shaders/4.2.texture.vs", "resources/shaders/4.2.texture.frag");
    shader lightingShader("resources/shaders/1.color.vs", "resources/shaders/1.color.frag");
    ...
    glGenVertexArrays(1, &cubeVAO);// 创建VAO - 只是一个状态记录器
    glGenBuffers(1, &VBO); // 创建VBO - 这才是真正存储数据的
   

    glBindBuffer(GL_ARRAY_BUFFER, VBO);
    glBufferData(GL_ARRAY_BUFFER, sizeof(vertices), vertices, GL_STATIC_DRAW);
    
    glBindVertexArray(cubeVAO);// 开始记录状态到当前VAO
    ...
    //second,configure(布局) the light's VAO
    ...
    glEnableVertexAttribArray(0);
    //---------------------------------------------------
    //load textures;加载纹理（CPU端）
    unsigned int diffuseMap = loadTexture("resources/textures/container2.png");
    unsigned int specularMap = loadTexture("resources/textures/container2_specular.png");
    // shader configuration(配置)
    // --------------------
    lightingShader.use();
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        lightingShader.setVec3("pointLights[0].ambient", 0.1f, 0.0f, 0.0f);
        ...
        lightingShader.setVec3("pointLights[1].ambient", 0.0f, 0.1f, 0.0f);
